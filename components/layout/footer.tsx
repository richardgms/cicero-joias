...
export function Footer() {
  return (
    <footer className="bg-esmeralda text-marfim">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8 bg-ouro rounded-lg flex items-center justify-center">
                <Gem className="w-5 h-5 text-grafite" />
              </div>
              <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/orcamento?tipo=alianças" className="text-marfim-dark hover:text-ouro transition-colors text-sm">
