  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('https://images.pexels.com/photos/1721934/pexels-photo-1721934.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <div className="animate-fade-in-up">
          ...
          <h1 className="font-playfair text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Tradição que se
            <span className="block text-primary gold-gradient bg-clip-text text-transparent">
              Renova
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button size="lg" variant="outline" asChild className="bg-white/10 backdrop-blur-md border-white/20 text-white hover:bg-white/20">
              <Link href="/portfolio">
                Ver Nosso Trabalho
              </Link>
            </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">Alianças Criadas</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center mb-2">
