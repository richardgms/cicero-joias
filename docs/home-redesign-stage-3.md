...
| --- | --- | --- | --- | --- |
| Hero | Declarar proposta de valor e iniciar conversa via WhatsApp. | Fundo em tom neutro com foto do ourives na bancada, headline ? esquerda, badge "40 anos", CTA s?lido, link secund?rio outline. | Headline: "C?cero Joias ? alian?as feitas ? m?o desde 1980". Sub: atendimento pelo WhatsApp, modelos na loja, execu??o pelo ourives. Badge: "40 anos de joalheria artesanal em Jo?o Pessoa". | Bot?o "Falar no WhatsApp agora" (wa.me/5583988073784). |
