        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-esmeralda via-esmeralda-dark to-[#0b1f18] py-24 text-marfim">
          ...
          <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 className="font-playfair text-4xl sm:text-5xl lg:text-6xl font-semibold leading-tight">
              Nossos <span className="text-ouro">Serviços</span>
            </h1>
        ...
        <section className="relative -mt-16 rounded-t-[48px] bg-marfim pb-24 pt-20">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              <h2 className="font-playfair text-3xl sm:text-4xl font-semibold text-esmeralda mb-4">
                Como <span className="text-ouro">podemos ajudar</span>
              </h2>
              <p className="mx-auto max-w-2xl text-base text-grafite/70">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {services.map((service) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-esmeralda mb-4 group-hover:text-esmeralda-dark transition-colors">
                    {service.title}
                  </h3>
                  <p className="text-sm text-grafite/70 leading-relaxed flex-grow">
                    {service.description}
                  </p>
                  <div className="mt-6 flex items-center text-sm font-medium text-ouro group-hover:text-ouro-light transition-colors">
                    Saiba mais
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-esmeralda via-esmeralda-dark to-[#04160f] py-24 text-marfim">
          ...
          <div className="relative mx-auto flex max-w-4xl flex-col items-center gap-8 px-4 text-center sm:px-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <Link
                href="/portfolio"
                className="inline-flex items-center justify-center rounded-full border border-marfim px-8 py-3 text-sm font-medium text-marfim transition-colors hover:bg-white/10"
              >
                Ver nosso portfólio
              </Link>
            </div>
