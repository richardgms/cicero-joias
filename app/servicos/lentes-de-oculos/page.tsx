...
import { OculosIcon } from '@/components/icons';
import { Button } from '@/components/ui/button';

export default function LentesDeOculosPage() {
  return (
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-2xl text-base text-grafite/70">
                  Esta página ainda não está pronta. Estamos trabalhando para trazer todas as informações detalhadas sobre nosso serviço de lentes de óculos.
                </p>
              </div>
