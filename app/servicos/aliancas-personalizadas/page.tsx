      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-esmeralda via-esmeralda-dark to-[#0b1f18] py-24 text-marfim">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center">
            <AliancasIcon className="h-16 w-16 text-ouro" />
          </div>
          <h1 className="font-playfair text-4xl sm:text-5xl lg:text-6xl font-semibold leading-tight">
            Alianças <span className="text-ouro">Personalizadas</span>
          </h1>
        </div>
      </section>
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-2xl text-base text-grafite/70">
                  Esta página ainda não está pronta. Estamos trabalhando para trazer todas as informações detalhadas sobre nosso serviço de alianças personalizadas.
                </p>
              </div>
