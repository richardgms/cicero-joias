                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="border-t pt-4 mt-2">
                            ...
                            {data?.checks.portfolioQuery?.error && (
                                <div className="bg-red-50 border border-red-200 rounded-md p-2 mt-2 text-xs text-red-800 break-words font-mono">
                                    <strong>Erro:</strong> {data.checks.portfolioQuery.error}
                                </div>
                            )}
                        </div>
                    </CardContent>
