...
import { Users, Package, TrendingUp, AlertCircle, Star, ShoppingBag } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            <span className="text-green-600">{stats.portfolio.active} ativos</span>
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            <span className="text-blue-600">{stats.products.readyDelivery} pronta entrega</span>
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-red-600">{stats.products.lowStock}</div>
                        <p className="text-xs text-muted-foreground">
